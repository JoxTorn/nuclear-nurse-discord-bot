...
exports.run = (client) => {
    ...
    function checkMessages(){
        ...
        if(guild){
            var channels = guild.channels.filter(channel => { return channel.name == 'reviving' || channel.name == 'jfk' || channel.name == 'ns' || channel.name == 'ak' || channel.name == 'elimination' || channel.name == 'pt-family' || channel.name == 'da' || channel.name == 'cr'});
