...
exports.run = (client) => {
    ...
    function checkMessages(){
        ...
        if(guild){
            var channels = guild.channels.filter(channel => { return channel.name == 'reviving' || channel.name == 'reviving-public' || channel.name == 'jux' || 
                channel.name == 'jfk' || channel.name == 'ns' || channel.name == 'ak' || channel.name == 'elimination' || channel.name == 'pt-family' || 
                channel.name == 'da' || channel.name == 'cr' || channel.name == 'vulpes' || channel.name == 'monarch' || channel.name == 'evo'});
